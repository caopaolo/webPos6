define([
    ...
    'ko',
    'Bkademy_Webpos/js/model/url-builder', // create url for api
    'Bkademy_Webpos/js/model/checkout/cart', // model cart
    'Magento_Catalog/js/price-utils', // has function which use to format price
    'Bkademy_Webpos/js/model/catalog/product/detail-popup' // model of detail popup
